...
void GDCC_HELPER_FUNC5() { //0x8C002948
	printf("GDCC_HELPER_FUNC5\n");
}

void GDCC_HELPER_FUNC10() { //0x8C00377C 
	printf("GDCC_HELPER_FUNC10\n");

	/*
RAM:8C00377C                 mov.l   r14, @-r15
RAM:8C00377E                 mov     r5, r14
RAM:8C003780                 mov.l   #h'FFFFEF76, r3
RAM:8C003782                 sts.l   pr, @-r15
RAM:8C003784                 bsrf    r3 ; GDCC_HELPER_FUNC2_IMPLEMENTED
RAM:8C003786                 mov     r5, r4
*/
	stack_push(r[14]);
	stack_push(Sh4cntx.pr);
	r[14] = r[5];
	...
	/*
RAM:8C003788                 mov.w   #h'BC, r0
RAM:8C00378A                 mov     #0, r4
RAM:8C00378C                 mov.w   #h'9C, r3
RAM:8C00378E                 mov.l   r4, @(r0,r14)
RAM:8C003790                 add     #-h'1C, r0
RAM:8C003792                 mov.l   @(r0,r14), r2
RAM:8C003794                 add     r3, r2
RAM:8C003796                 mov.b   r4, @r2
RAM:8C003798                 mov.l   #h'FFFFF01C, r2
RAM:8C00379A                 bsrf    r2 ; gd_popular_function_IMPLEMENTED
RAM:8C00379C                 mov     r14, r4
*/
	r[0] = 0xbc;
	r[4] = 0;
	r[3] = 0x9c;
	WriteMem32(r[0] + r[14], r[4]);
	r[0] += -0x1c;
	r[2] = ReadMem32(r[0] + r[14]);
	r[2] += r[3];
	WriteMem8(r[2], r[4]);
...
RAM:8C00379E                 mov.w   #h'9C, r3
RAM:8C0037A0                 mov     r3, r0
RAM:8C0037A2                 add     #4, r0
RAM:8C0037A4                 mov.l   @(r0,r14), r4
RAM:8C0037A6                 add     r3, r4
RAM:8C0037A8                 mov.b   @r4, r4
RAM:8C0037AA                 extu.b  r4, r0
RAM:8C0037AC                 lds.l   @r15+, pr
RAM:8C0037AE                 rts
RAM:8C0037B0                 mov.l   @r15+, r14
	*/
...
void GDCC_HELPER_FUNC9() { //0x8C002818
	//printf("GDCC_HELPER_FUNC9\n");


	/*
RAM:8C002818 GDCC_HELPER_FUNC9:                      
RAM:8C002818                                         
RAM:8C002818                 mov.l   r14, @-r15
RAM:8C00281A                 mov     r5, r14
RAM:8C00281C                 mov.l   r13, @-r15
RAM:8C00281E                 mov.l   r12, @-r15
RAM:8C002820                 mov.l   r11, @-r15
RAM:8C002822                 mov     r4, r12
RAM:8C002824                 sts.l   pr, @-r15
	*/
...
/*
RAM:8C002826 loc_8C002826:                         
RAM:8C002826                                        
RAM:8C002826                 mov.w   #h'B8, r0
RAM:8C002828                 mov.l   @(r0,r14), r2
RAM:8C00282A                 tst     r2, r2
RAM:8C00282C                 bf      loc_8C00285C
RAM:8C00282E                 mov     #1, r13
RAM:8C002830                 mov.w   #h'A8, r0
RAM:8C002832                 mov.l   r13, @(r0,r14)
RAM:8C002834                 mov.l   #h'FFFFF088, r11
RAM:8C002836                 mova    h'8C002838, r0
RAM:8C002838                 add     r0, r11
RAM:8C00283A                 jsr     @r11
*/
...
/*
RAM:8C00283C                 nop
RAM:8C00283E                 mov.w   #h'FFFFF904, r5
RAM:8C002840                 mov.w   #h'4F8, r4
RAM:8C002842                 mov.w   #h'A0, r0
RAM:8C002844                 mov.l   @(r0,r14), r3
RAM:8C002846                 add     r5, r3
RAM:8C002848                 mov.l   @r3, r2
RAM:8C00284A                 tst     r2, r13
RAM:8C00284C                 bt      loc_8C002864
RAM:8C00284E                 tst     r12, r12
RAM:8C002850                 bt      loc_8C00285C
RAM:8C002852                 mov.l   @(r0,r14), r3
RAM:8C002854                 add     r3, r4
RAM:8C002856                 mov.l   @r4, r2
RAM:8C002858                 add     #4, r0
RAM:8C00285A                 mov.l   r2, @(r0,r14)
RAM:8C00285C
*/
	r[5] = 0xFFFFF904;
	r[4] = 0x04f8;
	...
	WriteMem32(r[0] + r[14], r[3]);
	r[4] += r[3];
	r[2] = ReadMem32(r[4]);
	r[0] += 4;
	WriteMem32(r[0] + r[14], r[2]);

	/*
AM:8C00285C loc_8C00285C : ; CODE XREF : 
RAM : 8C00285C; 
RAM : 8C00285C                 mov.w   #h'A8, r0
RAM:8C00285E                 mov     #0, r4
RAM : 8C002860                 bra     loc_8C002874
RAM : 8C002862                 mov.l   r4, @(r0, r14)
RAM : 8C002864; -------------------------------------------------------------------------- -
RAM:8C002864*/
loc_8C00285C:
	r[0] = 0xa8;
	...
	goto loc_8C002874;
/*
RAM : 8C002864 loc_8C002864 : ; CODE XREF : 
RAM : 8C002864                 tst     r12, r12
RAM : 8C002866                 bt      loc_8C002826
RAM : 8C002868                 mov.l   @(r0, r14), r3
RAM : 8C00286A                 add     r3, r4
RAM : 8C00286C                 mov.l   @r4, r2
RAM : 8C00286E                 add     #4, r0
RAM : 8C002870                 bra     loc_8C002826
RAM : 8C002872                 mov.l   r2, @(r0, r14)
RAM : 8C002874; -------------------------------------------------------------------------- -
RAM:8C002874*/
...
/*
RAM : 8C002874 loc_8C002874 : ; CODE XREF :
RAM : 8C002874                 lds.l   @r15 + , pr
RAM : 8C002876                 mov.l   @r15 + , r11
RAM : 8C002878                 mov.l   @r15 + , r12
RAM : 8C00287A                 mov.l   @r15 + , r13
RAM : 8C00287C                 rts
RAM : 8C00287E                 mov.l   @r15 + , r14
*/
loc_8C002874:
	Sh4cntx.pr = stack_pop();
...
void  GDCC_HELPER_FUNC8() { //0x8C002BB6
	printf("GDCC_HELPER_FUNC8\n");

	/*
	RAM:8C002BB6                 mov.l   r14, @-r15
RAM:8C002BB8                 mov.l   r13, @-r15
RAM:8C002BBA                 sts.l   pr, @-r15
RAM:8C002BBC                 bsr     gd_common_subroutine_IMPLEMENTED
RAM:8C002BBE                 mov     r4, r14
RAM:8C002BC0                 bsr     GDCC_GENERIC_FUNC_IMPLEMENTED
RAM:8C002BC2                 mov     r14, r4
RAM:8C002BC4                 tst     r0, r0
RAM:8C002BC6                 bt      loc_8C002BCE
RAM:8C002BC8                 mov.l   #h'DEADDEAD, r0
RAM:8C002BCA                 bra     loc_8C002C22
RAM:8C002BCC                 nop
	*/
	...
	r[0] = 0xDEADDEAD;
	//Sh4cntx.pc = 0x8C002C22;


	/*
RAM:8C002BCE loc_8C002BCE:
RAM:8C002BCE                 mov     r14, r5
RAM:8C002BD0                 bsr     GDCC_HELPER_FUNC9_IMPLEMENTED
RAM:8C002BD2                 mov     #0, r4
RAM:8C002BD4                 mov.w   #h'B8, r0
RAM:8C002BD6                 mov.l   @(r0,r14), r3  ------------------------------------------
RAM:8C002BD8                 tst     r3, r3
RAM:8C002BDA                 bt      loc_8C002C10
RAM:8C002BDC                 mov     #2, r3
RAM:8C002BDE                 mov     r14, r5 ---------------
RAM:8C002BE0                 mov.l   r3, @(r0,r14)
RAM:8C002BE2                 mov.l   #h'B94, r3
RAM:8C002BE4                 bsrf    r3 ; GDCC_HELPER_FUNC10
RAM:8C002BE6                 mov     #0, r4 ---------------
	*/
...
loc_8C002BCE:
	...
	/*
RAM:8C002BE8                 mov     r0, r13 
RAM:8C002BEA                 mov.w   #h'D0, r0
RAM:8C002BEC                 mov.l   @(r0,r14), r2
RAM:8C002BEE                 tst     r2, r2
RAM:8C002BF0                 bt      loc_8C002C20
*/
	r[13] = r[0];
	r[0] = 0xd0;
	r[2] = ReadMem32(r[0] + r[14]);
	...
	/*
RAM:8C002BF2                 extu.b  r13, r0
RAM:8C002BF4                 and     #1, r0
RAM:8C002BF6                 cmp/eq  #1, r0
RAM:8C002BF8                 bf      loc_8C002C0C
	*/
	r[0] = (uint8_t)r[13];
...
RAM:8C002BFA                 mov.w   #h'84, r3
RAM:8C002BFC                 mov     r3, r0
RAM:8C002BFE                 add     #h'1C, r0
RAM:8C002C00                 mov.l   @(r0,r14), r0
RAM:8C002C02                 mov.b   @(r0,r3), r0
RAM:8C002C04                 extu.b  r0, r0
RAM:8C002C06                 and     #4, r0
RAM:8C002C08                 cmp/eq  #4, r0
RAM:8C002C0A                 bt      loc_8C002C20
	*/
	r[3] = 0x84;
	r[0] = r[3];
	r[0] += 0x1c;
	r[0] = ReadMem32(r[0] + r[14]);
	r[0] = ReadMem32(r[0] + r[3]);
	r[0] = (uint8_t)r[0];
	r[0] &= 4;
	if (4 == r[0])
		goto loc_8C002C20;
	...
	loc_8C002C0C:
	/*
RAM:8C002C0C loc_8C002C0C : ; CODE XREF :  
RAM : 8C002C0C                 bsr     gd_popular_function_IMPLEMENTED
RAM : 8C002C0E                 mov     r14, r4
RAM : 8C002C10*/
	...
	loc_8C002C10:
/*
RAM : 8C002C10 loc_8C002C10 : ; CODE XREF : 
RAM : 8C002C10                 mov.w   #h'9C, r3
RAM:8C002C12                 mov     r3, r0
RAM : 8C002C14                 add     #4, r0
RAM : 8C002C16                 mov.l   @(r0, r14), r13
RAM : 8C002C18                 add     r3, r13
RAM : 8C002C1A                 mov.b   @r13, r13
RAM : 8C002C1C                 bsr     gd_common_subroutine_IMPLEMENTED
RAM : 8C002C1E                 mov     r14, r4
RAM : 8C002C20
*/
	r[3] = 0x9c;
	r[0] = r[3];
	r[0] += 4;
	r[13] = ReadMem32(r[0] + r[14]);
	r[13] += r[3];
	r[13] = ReadMem8(r[13]);
	r[4] = r[14];
	gd_common_subroutine();
...
/*
RAM : 8C002C20 loc_8C002C20 : ; CODE XREF :  
RAM : 8C002C20;  
RAM : 8C002C20                 extu.b  r13, r0
RAM : 8C002C22*/
	...
	loc_8C002C22:
/*
RAM : 8C002C22 loc_8C002C22 : ; CODE XREF :  
RAM : 8C002C22                 lds.l   @r15 + , pr
RAM : 8C002C24                 mov.l   @r15 + , r13
RAM : 8C002C26                 rts
RAM : 8C002C28                 mov.l   @r15 + , r14
*/
	Sh4cntx.pr = stack_pop();
	r[13] = stack_pop();
	r[14] = stack_pop();
...
void GDCC_HELPER_FUNC7() { //0x8C002B4C
	printf("GDCC_HELPER_FUNC7\n");
	stack_push(r[14]);
	stack_push(Sh4cntx.pr);
	r[14] = r[7];
	r[15] -= 0xc; //Reserve STACK Space for vars

	WriteMem32(0x14 + (r[15] - 0x10), r[4]);
	r[5] = ReadMem32(r[15]);

	WriteMem32(0x14 + (r[15] - 0xC), r[6]);
	r[4] = r[7];
...
loc_8C002BA0:
	/*
RAM : 8C002BA0                 mov.l   @(h'14+var_C,r15), r5
	RAM:8C002BA2                 mov     r14, r6
	RAM : 8C002BA4                 mov.l   @(h'14+var_10,r15), r4
		RAM:8C002BA6                 add     #h'C, r15
		RAM:8C002BA8                 lds.l   @r15 + , pr
		RAM : 8C002BAA                 bra     loc_8C0029A8
		RAM : 8C002BAC                 mov.l   @r15 + , r14
		*/

	r[5] = ReadMem32(0x14 + (-0xc) + r[15]);
	r[6] = r[14];
	r[4] = ReadMem32(0x14 + (-0x10) + r[15]);
	r[15] += 0xc;
	Sh4cntx.pr = stack_pop();
	r[14] = stack_pop();
	Sh4cntx.pc = 0x8C0029A8;
}
#undef r
#endif
...
bool reios_syscalls_init() {
	...
	//g_syscalls_mgr.register_syscall("GDCC_HELPER_FUNC5", &GDCC_HELPER_FUNC5, 0x8C002948, k_no_vector_table);
 
	 
	//	g_syscalls_mgr.register_syscall("GDCC_HELPER_FUNC7", &GDCC_HELPER_FUNC7, 0x8C002B4C, k_no_vector_table);
	g_syscalls_mgr.register_syscall("GDCC_HELPER_FUNC8", &GDCC_HELPER_FUNC8, 0x8C002BB6, k_no_vector_table);
	g_syscalls_mgr.register_syscall("GDCC_HELPER_FUNC9", &GDCC_HELPER_FUNC9, 0x8C002818, k_no_vector_table);
	g_syscalls_mgr.register_syscall("GDCC_HELPER_FUNC10", &GDCC_HELPER_FUNC10, 0x8C00377C, k_no_vector_table);
