...
enum DreamcastKey
{
	...
	// Training mode control buttons (on axis)
	EMU_AXIS_BTN_JUMP_STATE    = EMU_BTN_JUMP_STATE,
	EMU_AXIS_BTN_QUICK_SAVE    = EMU_BTN_QUICK_SAVE,
	EMU_AXIS_BTN_PLAY          = EMU_BTN_PLAY,
	EMU_AXIS_BTN_RECORD        = EMU_BTN_RECORD,
	EMU_AXIS_BTN_PLAY_1        = EMU_BTN_PLAY_1,
	EMU_AXIS_BTN_RECORD_1      = EMU_BTN_RECORD_1,
	EMU_AXIS_BTN_PLAY_2        = EMU_BTN_PLAY_2,
	EMU_AXIS_BTN_RECORD_2      = EMU_BTN_RECORD_2,
	EMU_AXIS_BTN_SWITCH_PLAYER = EMU_BTN_SWITCH_PLAYER,
