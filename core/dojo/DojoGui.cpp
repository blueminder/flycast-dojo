...
void DojoGui::gui_display_guest_wait(float scaling)
{
	...
	if (!dojo.client.name_acknowledged)
	{
		...
		{
			ImGui::OpenPopup("Match Code Join");
			if (ImGui::BeginPopupModal("Match Code Join", NULL, ImGuiWindowFlags_AlwaysAutoResize | ImGuiInputTextFlags_EnterReturnsTrue))
			{
